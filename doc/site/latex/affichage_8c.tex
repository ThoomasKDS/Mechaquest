\doxysection{Référence du fichier /mnt/c/\+Users/mokha/\+Documents/travaille L2/projet/github/src/affichage.c}
\hypertarget{affichage_8c}{}\label{affichage_8c}\index{/mnt/c/Users/mokha/Documents/travaille L2/projet/github/src/affichage.c@{/mnt/c/Users/mokha/Documents/travaille L2/projet/github/src/affichage.c}}
...
\item 
int \mbox{\hyperlink{affichage_8c_a9a0c4550fcb73a704a8ecb9059731b40}{init\+\_\+background}} ()
...
int \mbox{\hyperlink{affichage_8c_a37762eaaf5ff37b10814afba0e6f0aa5}{init\+\_\+calque}} ()
...
void \mbox{\hyperlink{affichage_8c_a3d385ca0396c4c2b3001371505a410e4}{draw\+\_\+background}} ()
...
void \mbox{\hyperlink{affichage_8c_a78d50882c5d889e15ca86ddba5aa62bd}{draw\+\_\+calque}} ()
\begin{DoxyCompactList}\small\item\em Affiche le calque (overlay) actuel du jeu. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{affichage_8c_a1e25ed2b94d05cf8dae2fe968589573e}{init\+\_\+mat}} (int taille\+\_\+x, int taille\+\_\+y)
...
int \mbox{\hyperlink{affichage_8c_ad9d3b44ef81854da019931f0c15b40ca}{remplir\+\_\+mat}} (int taille\+\_\+x, int taille\+\_\+y)
...
void \mbox{\hyperlink{affichage_8c_acccbd26fc4489bcee9baa113b9dac4e1}{aff\+\_\+mat}} (int taille\+\_\+x, int taille\+\_\+y, int n\+\_\+mat)
...
void \mbox{\hyperlink{affichage_8c_a0e3013e95f4c920f17b775d33ac0ee82}{free\+\_\+mat}} (int taille\+\_\+x, int taille\+\_\+y)
...
int \mbox{\hyperlink{affichage_8c_a9de0b29edaa04d0f607cd14d448ff25e}{init\+\_\+player}} (char sexe)
...
int \mbox{\hyperlink{affichage_8c_a065c0902e63f16318150da6add0b96b6}{init\+\_\+pnj}} ()
...
int \mbox{\hyperlink{affichage_8c_aaf9b1b9fed295b95719d447183c0a7bb}{init\+\_\+mecha}} ()
\begin{DoxyCompactList}\small\item\em Initialise les textures des Méchas du jeu. \end{DoxyCompactList}\item 
SDL\+\_\+\+Rect \mbox{\hyperlink{affichage_8c_a0e1fc8eee26e274af453bd4630bd7566}{create\+\_\+obj}} (int taille\+\_\+w, int taille\+\_\+h, int x, int y, int type\+\_\+obj, int n\+\_\+mat)
...
void \mbox{\hyperlink{affichage_8c_ab476829218385851d4e69263f07e488b}{draw\+\_\+player}} (SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}obj, \mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j)
...
void \mbox{\hyperlink{affichage_8c_ae63215d67a18f635b3a1c2e1464a0a6f}{draw\+\_\+mecha}} (\mbox{\hyperlink{structmechas__t}{mechas\+\_\+t}} \texorpdfstring{$\ast$}{*}m, int x, int y, int h, int w, int orientation)
...
void \mbox{\hyperlink{affichage_8c_a16a8360b65479c7343b03f418ed56939}{draw\+\_\+all}} (\mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}sprite\+\_\+p, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}pnj\+\_\+sprite)
\begin{DoxyCompactList}\small\item\em Gère et affiche tous les éléments visuels principaux du jeu. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{affichage_8c_a81ed48c2407a1c13ac5884e0f162aaa7}{draw\+\_\+pnj}} (SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}obj, \mbox{\hyperlink{structpnj__t}{pnj\+\_\+t}} \texorpdfstring{$\ast$}{*}pnj, \mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j)
...
void \mbox{\hyperlink{affichage_8c_a26aea5bf98ae3244b38faf08e3ebd667}{draw\+\_\+obj}} (SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}obj, SDL\+\_\+\+Texture \texorpdfstring{$\ast$}{*}img)
\begin{DoxyCompactList}\small\item\em Dessine un objet générique à l\textquotesingle{}écran. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{affichage_8c_a7290dad76779d8dd7f48366a16812be8}{creer\+\_\+rectangle}} (\mbox{\hyperlink{structrectangle__t}{rectangle\+\_\+t}} \texorpdfstring{$\ast$}{*}rectangle, int w, int h, float x, float y, int r, int g, int b, int a, const char \texorpdfstring{$\ast$}{*}text)
...
void \mbox{\hyperlink{affichage_8c_ab54c358911a2ed823f20797846583531}{draw\+\_\+text\+\_\+left\+\_\+middle}} (\mbox{\hyperlink{structrectangle__t}{rectangle\+\_\+t}} \texorpdfstring{$\ast$}{*}rectangle)
...
void \mbox{\hyperlink{affichage_8c_a390da1c2cd15fd5355de26bd34b3d3dc}{draw\+\_\+text\+\_\+center}} (\mbox{\hyperlink{structrectangle__t}{rectangle\+\_\+t}} \texorpdfstring{$\ast$}{*}rectangle)
...
void \mbox{\hyperlink{affichage_8c_ac0e780352c4ab1739b9e31be92740c2d}{draw\+\_\+text\+\_\+pos}} (char \texorpdfstring{$\ast$}{*}text, int x, int y)
...
void \mbox{\hyperlink{affichage_8c_ab542b24175a0231f8530346fc8ab790f}{draw\+\_\+rect}} (\mbox{\hyperlink{structrectangle__t}{rectangle\+\_\+t}} \texorpdfstring{$\ast$}{*}rectangle, void(\texorpdfstring{$\ast$}{*}draw\+\_\+func)(\mbox{\hyperlink{structrectangle__t}{rectangle\+\_\+t}} \texorpdfstring{$\ast$}{*}))
\begin{DoxyCompactList}\small\item\em Dessine un rectangle coloré et son texte associé si présent. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{affichage_8c_a4f7e45e8554e8971bdba352cf9838405}{draw\+\_\+all\+\_\+rect}} (int n,...)
\begin{DoxyCompactList}\small\item\em Dessine plusieurs rectangles avec leurs textes centrés. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{affichage_8c_a265b0bc1ac18afe4fdf6233323561dd1}{afficher\+\_\+dialogue}} (\mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}sprite\+\_\+p, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}pnj\+\_\+sprite, char \texorpdfstring{$\ast$}{*}pseudo, char \texorpdfstring{$\ast$}{*}dialogue, int choix)
...
int \mbox{\hyperlink{affichage_8c_a1091893e7df87a967b878919b232b0d5}{afficher\+\_\+dialogue\+\_\+combat}} (\mbox{\hyperlink{structmechas__joueur__t}{mechas\+\_\+joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}mecha\+\_\+joueur, \mbox{\hyperlink{structmechas__joueur__t}{mechas\+\_\+joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}mecha\+\_\+ordi, char \texorpdfstring{$\ast$}{*}pseudo, char \texorpdfstring{$\ast$}{*}dialogue, int choix)
...
void \mbox{\hyperlink{affichage_8c_abd6001ed54f2062b95bb92ceef20e74a}{game\+\_\+over}} (\mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j)
...
int \mbox{\hyperlink{affichage_8c_a8d356fb4eb14df4797e1c82c54fb986a}{afficher\+Texte}} (SDL\+\_\+\+Renderer \texorpdfstring{$\ast$}{*}renderer, TTF\+\_\+\+Font \texorpdfstring{$\ast$}{*}font, const char \texorpdfstring{$\ast$}{*}texte, int x, int y)
\begin{DoxyCompactList}\small\item\em Affiche un texte multiligne à l\textquotesingle{}écran en gérant les sauts de ligne. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{affichage_8c_a76e0589a991f4ad00c5baae522dfeee1}{utiliser\+Objet\+Sur\+Mecha}} (int objet\+\_\+id, \mbox{\hyperlink{structmechas__joueur__t}{mechas\+\_\+joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}mecha, \mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j, char \texorpdfstring{$\ast$}{*}message\+\_\+buffer)
...
void \mbox{\hyperlink{affichage_8c_aff36844a9bc0417b311b691e2957adae}{afficher\+Mechadex}} (\mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}sprite\+\_\+p, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}pnj\+\_\+sprite, \mbox{\hyperlink{structgame__t}{game\+\_\+t}} \texorpdfstring{$\ast$}{*}game, int \texorpdfstring{$\ast$}{*}quitter\+\_\+total)
...
void \mbox{\hyperlink{affichage_8c_a9519a3474a5b9ff0162efbc07d652b0c}{afficher\+Selection\+Mecha}} (\mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}j, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}sprite\+\_\+p, SDL\+\_\+\+Rect \texorpdfstring{$\ast$}{*}pnj\+\_\+sprite, \mbox{\hyperlink{structgame__t}{game\+\_\+t}} \texorpdfstring{$\ast$}{*}game, int objet\+\_\+id, int \texorpdfstring{$\ast$}{*}quitter\+\_\+total)
...
int \mbox{\hyperlink{affichage_8c_af70cd65063ba7719d712c57fcce296a3}{affichage\+\_\+pc}} (\mbox{\hyperlink{structjoueur__t}{joueur\+\_\+t}} \texorpdfstring{$\ast$}{*}joueur)
\begin{DoxyCompactList}\small\item\em Affiche le PC du joueur permettant de gérer et échanger les Méchas capturés. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{affichage_8c_afc970416ff2ee1d9f8351a288625f23a}{concat}} (char \texorpdfstring{$\ast$}{*}dest, int nb)
\begin{DoxyCompactList}\small\item\em Concatène un entier à la fin d\textquotesingle{}une chaîne de caractères. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\Hypertarget{affichage_8c_acccbd26fc4489bcee9baa113b9dac4e1}\label{affichage_8c_acccbd26fc4489bcee9baa113b9dac4e1} 
\index{affichage.c@{affichage.c}!aff\_mat@{aff\_mat}}
\index{aff\_mat@{aff\_mat}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_af70cd65063ba7719d712c57fcce296a3}\label{affichage_8c_af70cd65063ba7719d712c57fcce296a3} 
\index{affichage.c@{affichage.c}!affichage\_pc@{affichage\_pc}}
\index{affichage\_pc@{affichage\_pc}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_af70cd65063ba7719d712c57fcce296a3_cgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a265b0bc1ac18afe4fdf6233323561dd1}\label{affichage_8c_a265b0bc1ac18afe4fdf6233323561dd1} 
\index{affichage.c@{affichage.c}!afficher\_dialogue@{afficher\_dialogue}}
\index{afficher\_dialogue@{afficher\_dialogue}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a265b0bc1ac18afe4fdf6233323561dd1_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a265b0bc1ac18afe4fdf6233323561dd1_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a1091893e7df87a967b878919b232b0d5}\label{affichage_8c_a1091893e7df87a967b878919b232b0d5} 
\index{affichage.c@{affichage.c}!afficher\_dialogue\_combat@{afficher\_dialogue\_combat}}
\index{afficher\_dialogue\_combat@{afficher\_dialogue\_combat}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a1091893e7df87a967b878919b232b0d5_cgraph}
\end{center}
\end{figure}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a1091893e7df87a967b878919b232b0d5_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a4bfda0a3d2e621f3521d2bcf1c59a7d5}\label{affichage_8c_a4bfda0a3d2e621f3521d2bcf1c59a7d5} 
\index{affichage.c@{affichage.c}!afficherInfosMecha@{afficherInfosMecha}}
\index{afficherInfosMecha@{afficherInfosMecha}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a4bfda0a3d2e621f3521d2bcf1c59a7d5_cgraph}
\end{center}
\end{figure}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a4bfda0a3d2e621f3521d2bcf1c59a7d5_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a17c5a7569d3f699b38d5124f198e916a}\label{affichage_8c_a17c5a7569d3f699b38d5124f198e916a} 
\index{affichage.c@{affichage.c}!afficherInventaire@{afficherInventaire}}
\index{afficherInventaire@{afficherInventaire}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a17c5a7569d3f699b38d5124f198e916a_cgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_aff36844a9bc0417b311b691e2957adae}\label{affichage_8c_aff36844a9bc0417b311b691e2957adae} 
\index{affichage.c@{affichage.c}!afficherMechadex@{afficherMechadex}}
\index{afficherMechadex@{afficherMechadex}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_aff36844a9bc0417b311b691e2957adae_cgraph}
\end{center}
\end{figure}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=302pt]{affichage_8c_aff36844a9bc0417b311b691e2957adae_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a9519a3474a5b9ff0162efbc07d652b0c}\label{affichage_8c_a9519a3474a5b9ff0162efbc07d652b0c} 
\index{affichage.c@{affichage.c}!afficherSelectionMecha@{afficherSelectionMecha}}
\index{afficherSelectionMecha@{afficherSelectionMecha}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a9519a3474a5b9ff0162efbc07d652b0c_cgraph}
\end{center}
\end{figure}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=327pt]{affichage_8c_a9519a3474a5b9ff0162efbc07d652b0c_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a8d356fb4eb14df4797e1c82c54fb986a}\label{affichage_8c_a8d356fb4eb14df4797e1c82c54fb986a} 
\index{affichage.c@{affichage.c}!afficherTexte@{afficherTexte}}
\index{afficherTexte@{afficherTexte}!affichage.c@{affichage.c}}
\doxysubsubsection{\texorpdfstring{afficherTexte()}{afficherTexte()}}
{\footnotesize\ttfamily int afficher\+Texte (\begin{DoxyParamCaption}\item[{SDL\+\_\+\+Renderer \texorpdfstring{$\ast$}{*}}]{renderer,  }\item[{TTF\+\_\+\+Font \texorpdfstring{$\ast$}{*}}]{font,  }\item[{const char \texorpdfstring{$\ast$}{*}}]{texte,  }\item[{int}]{x,  }\item[{int}]{y }\end{DoxyParamCaption})}



Affiche un texte multiligne à l\textquotesingle{}écran en gérant les sauts de ligne. 

Cette fonction parcourt une chaîne de texte, détecte les sauts de ligne ({\ttfamily \textbackslash{}n} ou séquence {\ttfamily \textbackslash{}\textbackslash{}n}), et affiche chaque ligne séparément à l\textquotesingle{}écran avec un décalage vertical entre elles.


\begin{DoxyParams}{Paramètres}
{\em renderer} & Un pointeur vers le {\ttfamily SDL\+\_\+\+Renderer} utilisé pour le rendu. \\
\hline
{\em font} & Un pointeur vers la police {\ttfamily TTF\+\_\+\+Font} utilisée pour dessiner le texte. \\
\hline
{\em texte} & La chaîne de caractères à afficher, pouvant contenir des sauts de ligne. \\
\hline
...
\end{DoxyParams}
\begin{DoxyReturn}{Renvoie}
Retourne la position {\ttfamily y} finale après avoir affiché toutes les lignes (utile pour continuer un rendu plus bas si besoin).
\end{DoxyReturn}
\begin{DoxyPrecond}{Précondition}

\begin{DoxyItemize}
\item Le renderer SDL ({\ttfamily renderer}) doit être initialisé et valide.
\item La police ({\ttfamily font}) doit être correctement chargée.
\item Le pointeur {\ttfamily texte} doit être non nul et contenir une chaîne valide.
\end{DoxyItemize}
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}

\begin{DoxyItemize}
\item Toutes les lignes du texte sont affichées à l\textquotesingle{}écran avec un décalage vertical de 25 pixels entre chaque ligne.
\end{DoxyItemize}
\end{DoxyPostcond}
\begin{DoxyNote}{Note}

\begin{DoxyItemize}
\item Les sauts de ligne peuvent être interprétés sous deux formes \+: un vrai caractère {\ttfamily \textbackslash{}n} ou la séquence de deux caractères {\ttfamily \textbackslash{}\textbackslash{}n}.
\end{DoxyItemize}
\end{DoxyNote}
\begin{DoxyWarning}{Avertissement}

\begin{DoxyItemize}
\item Une erreur dans la création des surfaces ou des textures peut empêcher l\textquotesingle{}affichage d\textquotesingle{}une ligne sans provoquer de crash.
\item {\ttfamily strdup} est utilisé pour copier le texte, veillez à libérer correctement cette mémoire même en cas d\textquotesingle{}erreur. 
\end{DoxyItemize}
\end{DoxyWarning}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a8d356fb4eb14df4797e1c82c54fb986a_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_afc970416ff2ee1d9f8351a288625f23a}\label{affichage_8c_afc970416ff2ee1d9f8351a288625f23a} 
\index{affichage.c@{affichage.c}!concat@{concat}}
\index{concat@{concat}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_afc970416ff2ee1d9f8351a288625f23a_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a0e1fc8eee26e274af453bd4630bd7566}\label{affichage_8c_a0e1fc8eee26e274af453bd4630bd7566} 
\index{affichage.c@{affichage.c}!create\_obj@{create\_obj}}
\index{create\_obj@{create\_obj}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_a7290dad76779d8dd7f48366a16812be8}\label{affichage_8c_a7290dad76779d8dd7f48366a16812be8} 
\index{affichage.c@{affichage.c}!creer\_rectangle@{creer\_rectangle}}
\index{creer\_rectangle@{creer\_rectangle}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a7290dad76779d8dd7f48366a16812be8_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a16a8360b65479c7343b03f418ed56939}\label{affichage_8c_a16a8360b65479c7343b03f418ed56939} 
\index{affichage.c@{affichage.c}!draw\_all@{draw\_all}}
\index{draw\_all@{draw\_all}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=262pt]{affichage_8c_a16a8360b65479c7343b03f418ed56939_cgraph}
\end{center}
\end{figure}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a16a8360b65479c7343b03f418ed56939_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a4f7e45e8554e8971bdba352cf9838405}\label{affichage_8c_a4f7e45e8554e8971bdba352cf9838405} 
\index{affichage.c@{affichage.c}!draw\_all\_rect@{draw\_all\_rect}}
\index{draw\_all\_rect@{draw\_all\_rect}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=282pt]{affichage_8c_a4f7e45e8554e8971bdba352cf9838405_cgraph}
\end{center}
\end{figure}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a4f7e45e8554e8971bdba352cf9838405_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a3d385ca0396c4c2b3001371505a410e4}\label{affichage_8c_a3d385ca0396c4c2b3001371505a410e4} 
\index{affichage.c@{affichage.c}!draw\_background@{draw\_background}}
\index{draw\_background@{draw\_background}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a3d385ca0396c4c2b3001371505a410e4_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a78d50882c5d889e15ca86ddba5aa62bd}\label{affichage_8c_a78d50882c5d889e15ca86ddba5aa62bd} 
\index{affichage.c@{affichage.c}!draw\_calque@{draw\_calque}}
\index{draw\_calque@{draw\_calque}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a78d50882c5d889e15ca86ddba5aa62bd_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_ae63215d67a18f635b3a1c2e1464a0a6f}\label{affichage_8c_ae63215d67a18f635b3a1c2e1464a0a6f} 
\index{affichage.c@{affichage.c}!draw\_mecha@{draw\_mecha}}
\index{draw\_mecha@{draw\_mecha}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_ae63215d67a18f635b3a1c2e1464a0a6f_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a26aea5bf98ae3244b38faf08e3ebd667}\label{affichage_8c_a26aea5bf98ae3244b38faf08e3ebd667} 
\index{affichage.c@{affichage.c}!draw\_obj@{draw\_obj}}
\index{draw\_obj@{draw\_obj}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_ab476829218385851d4e69263f07e488b}\label{affichage_8c_ab476829218385851d4e69263f07e488b} 
\index{affichage.c@{affichage.c}!draw\_player@{draw\_player}}
\index{draw\_player@{draw\_player}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_ab476829218385851d4e69263f07e488b_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a81ed48c2407a1c13ac5884e0f162aaa7}\label{affichage_8c_a81ed48c2407a1c13ac5884e0f162aaa7} 
\index{affichage.c@{affichage.c}!draw\_pnj@{draw\_pnj}}
\index{draw\_pnj@{draw\_pnj}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a81ed48c2407a1c13ac5884e0f162aaa7_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_ab542b24175a0231f8530346fc8ab790f}\label{affichage_8c_ab542b24175a0231f8530346fc8ab790f} 
\index{affichage.c@{affichage.c}!draw\_rect@{draw\_rect}}
\index{draw\_rect@{draw\_rect}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_ab542b24175a0231f8530346fc8ab790f_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a390da1c2cd15fd5355de26bd34b3d3dc}\label{affichage_8c_a390da1c2cd15fd5355de26bd34b3d3dc} 
\index{affichage.c@{affichage.c}!draw\_text\_center@{draw\_text\_center}}
\index{draw\_text\_center@{draw\_text\_center}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a390da1c2cd15fd5355de26bd34b3d3dc_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_ab54c358911a2ed823f20797846583531}\label{affichage_8c_ab54c358911a2ed823f20797846583531} 
\index{affichage.c@{affichage.c}!draw\_text\_left\_middle@{draw\_text\_left\_middle}}
\index{draw\_text\_left\_middle@{draw\_text\_left\_middle}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_ab54c358911a2ed823f20797846583531_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_ac0e780352c4ab1739b9e31be92740c2d}\label{affichage_8c_ac0e780352c4ab1739b9e31be92740c2d} 
\index{affichage.c@{affichage.c}!draw\_text\_pos@{draw\_text\_pos}}
\index{draw\_text\_pos@{draw\_text\_pos}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_ac0e780352c4ab1739b9e31be92740c2d_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a0e3013e95f4c920f17b775d33ac0ee82}\label{affichage_8c_a0e3013e95f4c920f17b775d33ac0ee82} 
\index{affichage.c@{affichage.c}!free\_mat@{free\_mat}}
\index{free\_mat@{free\_mat}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_abd6001ed54f2062b95bb92ceef20e74a}\label{affichage_8c_abd6001ed54f2062b95bb92ceef20e74a} 
\index{affichage.c@{affichage.c}!game\_over@{game\_over}}
\index{game\_over@{game\_over}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=274pt]{affichage_8c_abd6001ed54f2062b95bb92ceef20e74a_cgraph}
\end{center}
\end{figure}
Voici le graphe des appelants de cette fonction \+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=253pt]{affichage_8c_abd6001ed54f2062b95bb92ceef20e74a_icgraph}
\end{center}
\end{figure}
\Hypertarget{affichage_8c_a9a0c4550fcb73a704a8ecb9059731b40}\label{affichage_8c_a9a0c4550fcb73a704a8ecb9059731b40} 
\index{affichage.c@{affichage.c}!init\_background@{init\_background}}
\index{init\_background@{init\_background}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyNote}
\Hypertarget{affichage_8c_a37762eaaf5ff37b10814afba0e6f0aa5}\label{affichage_8c_a37762eaaf5ff37b10814afba0e6f0aa5} 
\index{affichage.c@{affichage.c}!init\_calque@{init\_calque}}
\index{init\_calque@{init\_calque}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyNote}
\Hypertarget{affichage_8c_a1e25ed2b94d05cf8dae2fe968589573e}\label{affichage_8c_a1e25ed2b94d05cf8dae2fe968589573e} 
\index{affichage.c@{affichage.c}!init\_mat@{init\_mat}}
\index{init\_mat@{init\_mat}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_aaf9b1b9fed295b95719d447183c0a7bb}\label{affichage_8c_aaf9b1b9fed295b95719d447183c0a7bb} 
\index{affichage.c@{affichage.c}!init\_mecha@{init\_mecha}}
\index{init\_mecha@{init\_mecha}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_a9de0b29edaa04d0f607cd14d448ff25e}\label{affichage_8c_a9de0b29edaa04d0f607cd14d448ff25e} 
\index{affichage.c@{affichage.c}!init\_player@{init\_player}}
\index{init\_player@{init\_player}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_a065c0902e63f16318150da6add0b96b6}\label{affichage_8c_a065c0902e63f16318150da6add0b96b6} 
\index{affichage.c@{affichage.c}!init\_pnj@{init\_pnj}}
\index{init\_pnj@{init\_pnj}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_ad9d3b44ef81854da019931f0c15b40ca}\label{affichage_8c_ad9d3b44ef81854da019931f0c15b40ca} 
\index{affichage.c@{affichage.c}!remplir\_mat@{remplir\_mat}}
\index{remplir\_mat@{remplir\_mat}!affichage.c@{affichage.c}}
...
\end{DoxyItemize}
\end{DoxyWarning}
\Hypertarget{affichage_8c_a76e0589a991f4ad00c5baae522dfeee1}\label{affichage_8c_a76e0589a991f4ad00c5baae522dfeee1} 
\index{affichage.c@{affichage.c}!utiliserObjetSurMecha@{utiliserObjetSurMecha}}
\index{utiliserObjetSurMecha@{utiliserObjetSurMecha}!affichage.c@{affichage.c}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{affichage_8c_a76e0589a991f4ad00c5baae522dfeee1_icgraph}
\end{center}
\end{figure}
