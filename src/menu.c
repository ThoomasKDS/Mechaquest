...
void afficher_informations(){
    ...
    rectangle_t Info_1,Info_2,Info_3,Info_4,Info_5,Info_6, Info_7, Info_8, Info_9,btn_retour;
    ...
    creer_rectangle(&Info_8,750,HAUTEUR_BOUTON,(largeurEcran - LARGEUR_BOUTON) / 2 - 275, 450,255, 255, 255, 100,"Pour ouvrir l'inventaire : I");
    creer_rectangle(&Info_9,750,HAUTEUR_BOUTON,(largeurEcran - LARGEUR_BOUTON) / 2 - 275, 500,255, 255, 255, 100,"Pour Selectionner un objet dans l'inventaire : ENTREE");
    creer_rectangle(&btn_retour,LARGEUR_BOUTON,HAUTEUR_BOUTON,(largeurEcran - LARGEUR_BOUTON) / 2, 550 ,98, 23, 8, 255,"Retour");
    ...
    while (running) {
        ...
        if(running) {
            SDL_RenderClear(game.renderer);
        draw_background();
        draw_all_rect(10, &Info_1, &Info_2, &Info_3, &Info_4, &Info_5, &Info_6, &Info_7, &Info_8, &Info_9 ,&btn_retour);
        SDL_RenderPresent(game.renderer);
